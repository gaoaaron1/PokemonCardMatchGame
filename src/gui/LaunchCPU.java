...
public class LaunchCPU extends CPUSelect {
    ...
    static LaunchCPU obj = new LaunchCPU(null);
...
//----------------------------------------------------------SCORE DISPLAY:
        ...
        Image p2ScoreImg = new Image("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\bin\\loopmusicjavaupdated\\computerScoreBtn.png");
        ...
        Player1text.setText("Player Score: ");
     ...
     // This lets the game detect the number of pairs so it will know when the game will end and draw out the images. 
        if (numpairs == 8) {
            if (Player1Score > Player2Score) {
                ...
                gameResultImg = new Image("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\bin\\loopmusicjavaupdated\\computerwin.png");
                grIV = new ImageView(gameResultImg);
            }
            else 
            {
...
//--------------------------------------------------// this is for the extra features.                        
       ...
       // 6 x 6 which is the difficulty for the graphics class.   
       if (difficulty == 6) {             
