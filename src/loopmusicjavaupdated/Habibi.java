...
public class Habibi extends Application {
	...
	public void start(Stage primaryStage) throws FileNotFoundException {
		...
		FileInputStream input = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\PokemonCard");
		FileInputStream one = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\Bulbasaur");
		FileInputStream two = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\Charmander");
		FileInputStream three = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\Squirtle");
		FileInputStream four = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\Pikachu");
		FileInputStream five = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\Meowth");
		FileInputStream six = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\mrmime");
		FileInputStream seven = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\Snorlax.png");
		FileInputStream eight = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\Jigglypuff");
		FileInputStream nine = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\Geodude");
		FileInputStream ten = new FileInputStream("file:C:\\Users\\Aaron\\eclipse-workspace\\CardMatchMemoryGame\\src\\loopmusicjavaupdated\\PokemonCard2");
